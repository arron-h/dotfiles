...
# Modified by Arron Hartley to provide nicer colours

[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Monokai-ArronH"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="Monokai-ArronH"
...
gset string background_color "#121212121212"
gset string foreground_color "#F6F6F5F5EEEE"
gset string bold_color "#FF99FF88FF55"
gset string font "Source Code Pro for Powerline 12"
